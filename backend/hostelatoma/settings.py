...
WSGI_APPLICATION = 'hostelatoma.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': config('DB_NAME', default='hostelatoma_db'),
...
# Cache — endpoints à fort trafic (catalogue/disponibilité) pourront s'appuyer
# dessus via cache_page/vary_on_cookie. LocMem en dev, Redis recommandé en prod
# (définir CACHE_URL=redis://... pour absorber la charge à ~200 connexions simultanées).
CACHES = {
    'default': {
        'BACKEND': config(
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='no-reply@smarthostelatoma.com')
