...
def _compute_amounts(reservation):
    """Montant du séjour (tarif par lit × lits réservés) + frais additionnels,
    depuis la grille tarifaire courante. Partagé par la génération initiale et
    le recalcul d'une facture existante — voir generate_proforma_invoice et
    recalculate_invoice ci-dessous."""
